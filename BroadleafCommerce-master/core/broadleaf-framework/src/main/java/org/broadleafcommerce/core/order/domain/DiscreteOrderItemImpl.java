...
public class DiscreteOrderItemImpl extends OrderItemImpl implements DiscreteOrderItem {
	...
	public boolean updateSaleAndRetailPrices() {
		...
		if (customPrice != null) {
			...
			price = customPrice.getAmount();

			setBaseSalePrice(new Money(customPrice.getAmount()));
			setSalePrice(new Money(customPrice.getAmount()));

			setBaseRetailPrice(new Money(customPrice.getAmount()));
			setRetailPrice(new Money(customPrice.getAmount()));
			updated = true;
			return updated;
		} else {
